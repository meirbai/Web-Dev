...
export class Product{
  ...
  link:String;
  type:String;
  constructor(name : String, image : String, desc : String, rat : Number, price : String, link:String,type:String) {
    this.name = name;
    this.image = image;
...
let prods = [
  {id:1, cl:iphone11},
  {id:2, cl:iphone13blue},
  {id:3, cl:cable},
  {id:4, cl:iCase},
  {id:5, cl:charger},
  {id:6, cl:pb},
  {id:7, cl:iphone15},
  {id:8, cl:iphone13white}
];
